 ...
 * \internal
 *
 * Constructs a BloodPressureMessage object with private implementation \a d.
 *
 * \param d Pointer to private implementation.
 */
BloodPressureMessage::BloodPressureMessage(BloodPressureMessagePrivate * const d) : AbstractDataMessage(d)
{
