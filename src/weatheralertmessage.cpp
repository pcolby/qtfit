 ...
 * \internal
 *
 * Constructs a WeatherAlertMessage object with private implementation \a d.
 *
 * \param d Pointer to private implementation.
 */
WeatherAlertMessage::WeatherAlertMessage(WeatherAlertMessagePrivate * const d) : AbstractDataMessage(d)
{
